...
$canonicalURL = "https://sizaf.com/disclaimer.php"; 
include('header.php');
?>
                    ...
                    <div class="p-0">
                        <div class="h-[300px] overflow-y-auto">
                            <nav class="p-4 space-y-2">
                                <?php
                                $tableOfContents = [
                                    ['id' => 'webdisclaimer', 'title' => "Website Disclaimer", 'icon' => 'shield-alert'],         
                                    ['id' => 'links', 'title' => "External Links", 'icon' => 'link'],                              
                                    ['id' => 'proffdisclaimer', 'title' => "Professional Disclaimer", 'icon' => 'briefcase'],      
                                    ['id' => 'affiliatedisclaimer', 'title' => "Affiliates Disclaimer", 'icon' => 'users'],        
                                    ['id' => 'testimonialdisclaimer', 'title' => "Testimonials Disclaimer", 'icon' => 'quote'],   
                                    ['id' => 'errors', 'title' => "Errors & Omissions", 'icon' => 'alert-triangle'],              
                                    ['id' => 'contributors', 'title' => "Guest Contributors", 'icon' => 'user-plus'],              
                                    ['id' => 'logos', 'title' => "Logos & Trademarks", 'icon' => 'badge-check'],                   
