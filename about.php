      ...
      <div>
        <div class="border-0 shadow-xl bg-pink-500 text-white overflow-hidden rounded-lg relative">
          ...
          <div class="p-8 relative z-10">
            ...
            <form class="space-y-5" action="/contact" method="POST" itemscope itemtype="https://schema.org/ContactPage">
              ...
              <div class="pt-2">
                <button
                  type="submit"
                  class="w-full bg-slate-900 hover:bg-slate-800 text-white font-medium py-3 rounded-md flex items-center justify-center transition-colors"
                >
...
@media print {
  ...
  .bg-slate-800\/50, .bg-slate-900, .bg-pink-500 {
    background: #f8f8f8 !important;
  }
  
  .text-white, .text-slate-300, .text-pink-400 {
    color: #000 !important;
  }
